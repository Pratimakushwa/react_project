...
const Doc1 = () => {
  ...
  const handlebutton = () => {
    ...
    if (isLoggedIn) {
      ...
      alert("Please signup or login first to book an appointment!");
      navigate("/Signup"); 
    }
  };
...
//     <div className ="bg-white rounded-2xl p-4 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer flex justify-evenly m-30 pt-24">
//         <div >
//               <img src={pic2} alt="" className="w-64 h-64 object-cover rounded-xl" />
//               <p className="text-2xl font-black">Dr. Rechad James</p>
...
//                 <button className='bg-amber-500 rounded-2xl p-2 ' onClick={handlebutton}>book appoiment</button>
//             </div>
//     </div>
